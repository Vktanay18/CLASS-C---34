...
function setup() 
{
  ...
  star = createSprite(315,50,20,20)
  star.addImage(starimg)
  star.scale = 0.02

  star1 = createSprite(120,370,20,20)
  star1.addImage(starimg)
  star1.scale = 0.02
  
  blowerimg = createImg("baloon2.png")
  blowerimg.position(260,370)
  blowerimg.size(120,120)
  blowerimg.mouseClicked(airblow)

  displaystar = createSprite(70,20,30,30)
